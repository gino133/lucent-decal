const ProjectGrid = ({ content, style }) => {
  ...
  return (
    <section className="py-16 md:py-32 bg-surface-container-lowest" style={{ backgroundColor: style.backgroundColor }}>
      <div className="px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
        <div className="flex justify-between items-end mb-12">
          ...
          {viewAllLink && (
            <a className="font-label-bold text-label-bold text-secondary-fixed-dim hover:text-secondary-fixed transition-colors flex items-center group" href={viewAllLink}>
